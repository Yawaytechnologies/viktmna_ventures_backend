import { createInvestor, getAllInvestors, getInvestorById, deleteInvestor } from "./invester.service.js";
import { emailValidator, panNumberValidator, pincodeValidator, mobileNumberValidator } from "./invester.validation.js";
import { slabConfig } from "../../config/slab_config.js";


export const createInvestorController = async (req, res) => {
    try {
        const { fullName, email, mobileNumber, address, pincode, panNumber, investorType,  preferredStage,  sectorsOfInterest, anythingElse, logo ,slab } = req.body;
